...
public class AccountService {
    ...
    private Account createNewAccount(@Valid SingUpRequest accountForm) {
    ...
    public Account duplicatedEmail(Account account) {
        return newAccount;
    }
    ...
    public void signUp(Account account){
        ...
        Account newAccount = createNewAccount(account);
        sendSignUpEmail(newAccount);    // 
        login(account);  //회원가입 후 자동 로그인
    }
